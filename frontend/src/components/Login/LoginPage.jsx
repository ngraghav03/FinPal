    ...
    return (
      <>
        {/*
          ...
          ```
        */}
        <div className="flex h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8 dark:bg-gradient-to-br from-darkestblue from-10% to-cyan-700 to-90% via-darkblue via-40%">
          <div className="flex items-center justify-center">
            <div className="dark:bg-darkblue border-2 border-lighterblue w-1/4 p-7 rounded-xl">
