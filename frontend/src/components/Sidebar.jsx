...
function Sidebar() {
    return (
        <>
            <aside className="top-0 left-0 z-40 w-full h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-darkblue dark:border-gray-700" aria-label="Sidebar">
