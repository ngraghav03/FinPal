            ...
            {/* <div className="m-3">
                <button className="flex flex-col items-center">
                    ...
                    className="dark:fill-white dark:bg-amber-500 p-2 w-11 h-11 rounded-full">
                        <g>
                            <path d="M332.571,140.81l-16.665,16.648c-41.547-24.17-95.688-18.468-131.288,17.116l153.521,153.52
                                c35.583-35.592,41.294-89.732,17.115-131.278l16.666-16.657L332.571,140.81z"/>
                            <path d="M0,299.943c0,0,9.585,18.251,28.989,45.303c14.864-9,51.042-31.664,90.012-61.833l6.324,6.332
                                ...
                                <rect x="334.304" y="62.854" transform="matrix(0.7071 -0.7071 0.7071 0.7071 67.7361 328.4017)" width="191.963" height="39.163"/>
                        </g>
                    </svg>
...
export default HomeSuppliesIcon;